...
export type TextLayerRenderParameters = {
     ...
     */
    textContent?: import("pdfjs-dist/types/display/api").TextContent | undefined;
    /**
     ...
     */
    viewport: import("pdfjs-dist/types/display/display_utils").PageViewport;
    /**
...
declare class TextLayerRenderTask {
    ...
    _canceled: boolean;
    _capability: import("pdfjs-dist/types/shared/util").PromiseCapability;
    _renderTimer: any;
    _bounds: any[];
    /**
