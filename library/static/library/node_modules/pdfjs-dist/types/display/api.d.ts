...
export class PDFDataRangeTransport {
    ...
    _readyCapability: import("pdfjs-dist/types/shared/util").PromiseCapability;
...
import { DOMCanvasFactory } from "pdfjs-dist/types/display/display_utils";
import { DOMCMapReaderFactory } from "pdfjs-dist/types/display/display_utils";
/**
 * The loading task controls the operations required to load a PDF document
 * (such as network requests) and provides a way to listen for completion,
 * after which individual pages can be rendered.
...
import { info } from "pdfjs-dist/types/shared/util";
import { Metadata } from "pdfjs-dist/types/display/metadata";
import { StatTimer } from "pdfjs-dist/types/display/display_utils";
/**
